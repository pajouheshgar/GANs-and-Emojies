...
train_config = {"learning_rate":[0.0004, 0.7, 1000]}
train_config.update(train_config_init)
test_optims, test_fd = GANBlocks.testGAN(dcgen, dcdis, bedis, config, z_len=z_len, image_shape=image_size + [4], minimax=False)
